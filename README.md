...
```bash
sudo dpkg -i mobilepkg_0.5.2_linux_amd64.deb   # Debian, Ubuntu
sudo rpm -i mobilepkg_0.5.2_linux_amd64.rpm    # Fedora, RHEL
sudo apk add --allow-untrusted mobilepkg_0.5.2_linux_amd64.apk  # Alpine
```
